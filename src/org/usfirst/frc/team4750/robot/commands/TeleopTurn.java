...
/**
 * This command handles turning in teleop, resetting the IMU each time we turn
 *
 */
public class TeleopTurn extends Command {
	...
	static final double I = 0.002; // 0.003
	static final double D = 0.05; // 0.05
	static final double F = 0.6; // 0.6

	// Minimum error
	static final double toleranceDegrees = 5.0;

	public TeleopTurn(float targetHeading) {
		// Get heading
